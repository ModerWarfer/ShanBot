...
//FIN DE REGISTRO  
            ...
            break
				    ...
				    try{
						if (!isNsfw) return reply('❌ *NSFW NO ESTA ACTIVADO* ❌')
                                                if (!isUser) return reply(mess.only.daftarB)
						res = await fetchJson(`https://nekos.life/api/v2/img/pwankg`, {method: 'get'})
	...
	if (budy.startsWith(`Pongan cuties`)) { 
		...
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		 ...
		 if (budy.startsWith(`jaj`)) {
        const none = fs.readFileSync('./mp3/bob.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }	
		 if (budy.startsWith(`Jaj`)) {
        const none = fs.readFileSync('./mp3/bob.mp3');
        ...
        const none = fs.readFileSync('./mp3/pic.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }		
		 if (budy.startsWith(`Gay`)) {
        const none = fs.readFileSync('./mp3/pic.mp3');
        ...
        const none = fs.readFileSync('./mp3/aler.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`so`)) {
		...
		if (budy.startsWith(`teta`)) {
        const none = fs.readFileSync('./mp3/joder.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`Teta`)) {
        const none = fs.readFileSync('./mp3/joder.mp3');
        ...
        const none = fs.readFileSync('./mp3/ilegal.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`Loli`)) {
        const none = fs.readFileSync('./mp3/ilegal.mp3');
		...
		if (budy.startsWith(`nsfw`)) {
        const none = fs.readFileSync('./mp3/ilegal.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`maten`)) {
        const none = fs.readFileSync('./mp3/ilegal.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`Maten`)) {
		...
		if (budy.startsWith(`empanada`)) {
        const none = fs.readFileSync('./mp3/empa.mp3');
		client.sendMessage(from, none, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                  }
		if (budy.startsWith(`Empanada`)) {
        const none = fs.readFileSync('./mp3/empa.mp3');
